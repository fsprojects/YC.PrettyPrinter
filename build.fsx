...
let project = "YC.PrettyPrinter"

// Short summary of the project
// (used as description in AssemblyInfo and as a short summary for NuGet package)
let summary = "Pretty printing library"
...
Target "RunTests" (fun _ ->
    ...
    |> NUnit3 (fun p ->
        { p with
            ...
            WorkingDir = "tests/YC.PrettyPrinter.Tests/bin/Release" })
)
...
Target "NuGet" (fun _ ->
    ...
    Paket.Pack(fun p ->
        printfn "%A" p 
        printfn "Dir = %A" Environment.CurrentDirectory
        let p = 
            { p with
                OutputPath = "bin"
